...
//WebUI.click(findTestObject('Object Repository/Negative_test_1/OBJ_NEGATIVE/Page_Demo/svg'))
WebUI.click(findTestObject('Object Repository/Negative_test_1/OBJ_NEGATIVE/Page_Cart  Demo/button_Create Purchase Request'))

WebUI.getText(findTestObject('Object Repository/Negative_test_1/OBJ_NEGATIVE/Page_Cart  Demo/div_Please select Project Codes'), 
